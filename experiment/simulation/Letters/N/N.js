...
function startDrawing(e) {
    ...
    switch (nextConnection) {
        ...
        case 'dot3-dot2':
            targetDot = dot3;
            break;
        case 'dot6-dot2': // Changed from 'dot2-dot6' to 'dot6-dot2'
            targetDot = dot6; // Changed from dot6 to dot2
            break;
    }
    ...
    drawToleranceCircle(nextConnection.includes('dot3') ? dot3 : dot2, ctx);
...
function stopDrawing(e) {
    ...
    switch (nextConnection) {
        ...
        case 'dot3-dot2':
            ...
            break;
        case 'dot6-dot2': // Changed from 'dot2-dot6' to 'dot6-dot2'
            targetDot = dot2; // Changed from dot6 to dot2
            break;
    }
    ...
    if (checkDotTolerance(targetDot, x, y)) {
        ...
        switch (nextConnection) {
            ...
            case 'dot3-dot2':
                strokeId = '2';
                nextConnection = 'dot6-dot2'; // Changed from 'dot2-dot6' to 'dot6-dot2'
                arrow2.style.display = 'none';
